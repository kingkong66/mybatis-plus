 ...
 * @function:分布式随机ID生成器
 * @version: 1.0
 * @Create at: 2017年8月14日 下午2:43:28
 */
public class DistrIdGenerator {

    private static final Logger logger = LoggerFactory.getLogger(DistrIdGenerator.class);
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 10100; i++) {
            String id=DistrIdGenerator.createRandomId();
