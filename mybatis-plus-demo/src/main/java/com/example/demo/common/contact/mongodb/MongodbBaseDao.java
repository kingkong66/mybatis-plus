...
public abstract class MongodbBaseDao<T> {
	...
	public List<Object> distinct(String key, String collectionName, Query query) {
	/*	List<Object> queryOpenids = mongoTemplate.getCollection(collectionName).distinct(key, query.getQueryObject());
		return queryOpenids;
		*/
	return null;
	}
